...
function getRanks(mut) {
  // Your implementation of getRanks here.
}

function bigInt(value) {
  // Your implementation of bigInt here.
}

function addColor(mut, color) {
  // Your implementation of addColor here.
}

// Assuming you have an 'options' variable defined somewhere in your code.

onMessageAdd(function (mut, name, message, id) {
  if (options.colornames && (options.colornamesover || !getRanks(mut).length)) {
